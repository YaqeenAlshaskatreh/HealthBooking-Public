...
export default {
  ...
  methods: {
    fetchAppointments() {
      fetch("https://67brc7h5vc.execute-api.eu-north-1.amazonaws.com/prod/appointments")
        .then(res => res.json())
        .then(data => {
    ...
    updateStatus(appointment, newStatus) {
      ...
      const url = `https://67brc7h5vc.execute-api.eu-north-1.amazonaws.com/prod/appointments/${appointment.appointmentId}`;
